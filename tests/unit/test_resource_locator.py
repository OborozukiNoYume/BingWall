...
def test_resource_locator_builds_local_and_oss_urls() -> None:
    ...
    local_url = locator.build_url(
        ...
        relative_path="bing/2026/03/en-US/example--preview.jpg",
    )
    ...
    assert local_url == "/images/bing/2026/03/en-US/example--preview.jpg"
    assert oss_url == "https://cdn.example.com/bingwall/bing/2026/03/en-US/example--preview.jpg"
