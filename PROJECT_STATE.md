...
- 当前阶段：阶段一 `T1.1` 已完成，准备进入 `T1.2`
- 状态说明：仓库已完成一期系统设计总纲、配套文档骨架、经系统级校准的阶段路线图，并已落地 `T1.1` 的最小后端工程骨架、统一配置入口、运行时版本锁定、最小 FastAPI 应用与基础验证命令
...
- 已提供 `make setup`、`make verify`、`make run` 统一命令入口
