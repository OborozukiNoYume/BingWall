...
- 已实现 `/admin/login`、`/admin`、`/admin/wallpapers`、`/admin/wallpapers/{wallpaper_id}`、`/admin/change-password` 与 `/admin/audit-logs` 后台页面，并通过 `web/admin/assets/admin.js`、`web/admin/assets/admin.css` 约束页面仅调用后台 API，不直接访问数据库或图片目录
