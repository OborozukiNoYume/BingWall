...
- 已清理 `.gitignore` 中遗留的 `pyenv`、旧虚拟环境和无关包管理器模板段，并修正 [docs/setup-troubleshooting.md](/home/ops/Projects/BingWall/docs/setup-troubleshooting.md) 中对旧锁文件方案的表述，避免读者误以为仓库仍处于 `uv` 半迁移状态
